...
const generateM3u = async (ud) => {
    ...
    for (let i = 0; i < chansList.length; i++) {
        ...
        m3uStr += 'group-title="' + (chansList[i].group_title) + '", tvg-logo="https://mediaready.videoready.tv/tatasky-epg/image/fetch/f_auto,fl_lossy,q_auto,h_1000,w_1000/' + (chansList[i].tvg_logo) + '", ' + chansList[i].name + '\n';
